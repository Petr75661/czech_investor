...
Otevřete Plánovač úloh (Task Scheduler) ve Windows.

Zvolte Vytvořit základní úlohu a pojmenujte ji Czech Investor Nákup.

Nastavte spouštění Měsíčně.

V kroku "Akce" zvolte Spustit program.

Do pole Program/skript vložte cestu k pythonw.exe (např. C:\Users\Jmeno\AppData\Local\Programs\Python\Python312\pythonw.exe).

Do pole Argumenty vložte celou cestu k vašemu skriptu (např. "C:\Investice\stocks.py").
